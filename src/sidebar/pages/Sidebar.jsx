            ...
            <ul>
                ...
                <li>
                    <Link to="/Work" className={location.pathname.startsWith("/Work") ? "active" : ""}>
                        ...
                        <span className="sidebar-text">{t('sidebar.nav.works')}</span>
                    </Link>
                </li>
                <li>
                    <Link to="/Contactme" className={location.pathname === "/Contactme" ? "active" : ""}>
                        ...
                        <span className="sidebar-text">{t('sidebar.nav.contact')}</span>
                    </Link>
                </li>
                <li>
